...
public class Cx_HelpDesk_page_CreateTicket_DeliveryIssueLocator extends TestBase {
    ...
    @FindBy(xpath = "//h4[contains(text(),'Delivery Issue')]/../..//label[contains(text(),'Invoice Number')]/..//select")
    public WebElement InvoiceNumber;

    @FindBy(xpath = "//select[@id='selectBoxIssue']")
    public WebElement selectBoxIssue; //Other

    @FindBy(xpath = "//label[contains(text(),'Upload Image *')]/..//div[@data-trigger='fileinput']")
    public WebElement UploadImage;

    @FindBy(xpath = "//label[contains(text(),'Message *')]/..//input[@type='text']")
    public WebElement Message;

    @FindBy(xpath = "//h4[contains(text(),'Delivery Issue')]/../..//button[contains(text(),'Submit')]")
    ...
    public void createTicketWithDeliveryIssue(){
        ...
        try {
            ...
            Select selectIssue = new Select(selectBoxIssue);
            selectIssue.selectByVisibleText("Other"); //Other
            genericUtil.pause(1000);

            HighlightElement.highlightElement(UploadImage);
            genericUtil.clickWithPause(UploadImage, 2000);
